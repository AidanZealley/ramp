...
export const FREE_RIDE_CAMERA = {
  ...
  yawDriftFullCurvature: 0.008,
  yawDriftSpeedMinRatio: 0.05,
  yawDriftSpeedFullRatio: 0.35,
...
export const FREE_RIDE_TARGETS = {
  ...
  minGapMeters: 5,
  maxGapMeters: 100,
  draftLockGapMeters: 5,
  draftUnlockGapMeters: 8,
  draftQualityFullGapMeters: 5,
  draftQualityZeroGapMeters: 8,
  draftQualityHudSegmentCount: 10,
  draftQualityLabel: "Draft Quality",
  draftHudColor: "#5cffd1",
  weaponChargePowerFtpRatio: 0.95,
  weaponChargeFullSeconds: 10,
  weaponChargeHudSegmentCount: 12,
  weaponChargeLabel: "Weapon Charge",
  weaponChargeHudColor: "#ffcf5c",
  weaponFireSeconds: 0.35,
  weaponKillVanishSeconds: 1.2,
  weaponKillBoomSeconds: 1.2,
  weaponShotOriginBehindMeters: 3.2,
  weaponShotOriginLiftMeters: 0.35,
  weaponShotOriginLateralMeters: 0,
  weaponShotColor: "#19f4ff",
  weaponShotCoreColor: "#ffcf5c",
  weaponShotSparkCount: 56,
  weaponShotArcCount: 9,
  weaponKillBoomParticleCount: 168,
  weaponKillBoomShardCount: 96,
  weaponKillBoomColor: "#ffcf5c",
  weaponKillShockwaveColor: "#19f4ff",
  weaponKillHudLabel: "Target Destroyed",
  draftHighlightIntensity: 2.4,
  draftWakeParticleCount: 132,
  draftDustParticleCount: 180,
  draftWakeLengthMeters: 19,
  draftWakeWidthMeters: 1.95,
